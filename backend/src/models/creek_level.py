...
class TouchDetail(BaseModel):
    """
    Detailed information about a single creek touch (pivot low test).

    Attributes:
        index: Bar index of the touch
        price: Pivot low price at this touch
        ...
        rejection_wick: (close - low) / spread, measures upward rejection
        timestamp: Bar timestamp
    """

    index: int = Field(..., ge=0, description="Bar index")
    price: Decimal = Field(..., decimal_places=8, max_digits=18, description="Pivot low price")
