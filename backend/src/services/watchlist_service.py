...
class WatchlistService:
    ...
    async def get_entry(self, user_id: UUID, symbol: str) -> WatchlistEntry | None:
        """
        Get a single watchlist entry for a user and symbol.
        ...
        Story 19.24: Used for per-symbol confidence filtering
        """
        return await self.repository.get_symbol(user_id, symbol)
