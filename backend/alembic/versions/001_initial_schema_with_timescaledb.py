...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            comment="Support level (Wyckoff creek)",
        ),
        sa.Column(
            "ice_level",
            sa.NUMERIC(precision=18, scale=8),
            nullable=False,
            comment="Resistance level (Wyckoff ice)",
        ),
        sa.Column(
            "jump_target",
            sa.NUMERIC(precision=18, scale=8),
            nullable=False,
            comment="Projected price target",
        ),
        sa.Column(
            "cause_factor",
            sa.NUMERIC(precision=4, scale=2),
            nullable=False,
            comment="Wyckoff cause-effect ratio",
        ),
        sa.Column("range_width", sa.NUMERIC(precision=10, scale=4), nullable=False),
        sa.Column(
            "phase", sa.String(length=1), nullable=False, comment="Wyckoff phase: A, B, C, D, or E"
        ),
        sa.Column(
            "strength_score", sa.Integer(), nullable=False, comment="Range quality score 60-100"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "spread", sa.NUMERIC(precision=18, scale=8), nullable=False, comment="high - low"
        ),
        sa.Column(
            "spread_ratio",
            sa.NUMERIC(precision=10, scale=4),
            nullable=False,
            comment="Spread vs 20-bar average",
        ),
        sa.Column(
            "volume_ratio",
            sa.NUMERIC(precision=10, scale=4),
            nullable=False,
            comment="Volume vs 20-bar average",
        ),
        sa.Column(
            "created_at",
            sa.TIMESTAMP(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "pattern_type", sa.String(length=10), nullable=False, comment="SPRING, UTAD, SOS, etc."
        ),
        sa.Column("symbol", sa.String(length=20), nullable=False),
        sa.Column("timeframe", sa.String(length=5), nullable=False),
        sa.Column(
            ...
            sa.TIMESTAMP(timezone=True),
            nullable=False,
            comment="When algo detected pattern",
        ),
        sa.Column(
            "pattern_bar_timestamp",
            sa.TIMESTAMP(timezone=True),
            nullable=False,
            comment="Actual bar where pattern occurred",
        ),
        ...
        sa.Column(
            ...
            nullable=False,
            comment="Pattern-specific flexible metadata",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            comment="Max 5% portfolio allocation",
        ),
        ...
        sa.Column(
            ...
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Array of entry objects",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Validation steps passed",
        ),
        sa.Column(
            "created_at",
            sa.TIMESTAMP(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            postgresql.UUID(as_uuid=True),
            nullable=False,
            comment="Groups results from same backtest run",
        ),
        sa.Column("symbol", sa.String(length=20), nullable=False),
        sa.Column("timeframe", sa.String(length=5), nullable=False),
        ...
        sa.Column(
            "precision", sa.NUMERIC(precision=6, scale=4), nullable=False, comment="TP / (TP + FP)"
        ),
        sa.Column(
            "recall", sa.NUMERIC(precision=6, scale=4), nullable=False, comment="TP / (TP + FN)"
        ),
        ...
        sa.Column(
            ...
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Detector configuration used",
        ),
