...
def test_calculate_phase_a_confidence_high(sc_dict, ar_dict):
    ...
    # SC: 85 confidence → ~42 pts
    # AR: 100 default → 30 pts
...
def test_calculate_phase_b_confidence_high(st1_dict, st2_dict):
    ...
    events = PhaseEvents(
        secondary_tests=[st1_dict, st2_dict, st3_dict]
    )

    confidence = calculate_phase_b_confidence(events, duration=25)

    # ST quality: avg 81 → 32 pts
    # ST count: 3 → 30 pts
    # Duration: 25 → 25 pts
    # Total: 87 pts
...
def test_calculate_phase_b_confidence_minimal(st1_dict):
    ...
    # ST quality: 80 → 32 pts
    # ST count: 1 → 10 pts
    # Duration: 12 → 15 pts
    # Total: 57 pts
    assert 50 <= confidence <= 65
...
def test_classify_phase_e_success(sc_dict, ar_dict, st1_dict, st2_dict, spring_dict, sos_dict, lps_dict):
...
def test_classify_phase_progression(sc_dict, ar_dict, st1_dict, st2_dict, spring_dict, sos_dict, lps_dict):
