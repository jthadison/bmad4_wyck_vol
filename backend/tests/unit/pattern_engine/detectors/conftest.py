"""
Shared test fixtures for detector orchestrator tests.
"""
...
@pytest.fixture
def volume_analysis(ohlcv_bar):
    """Create test volume analysis."""
    return {
        ohlcv_bar.timestamp: {
            "volume_ratio": Decimal("2.5"),
            "spread_ratio": Decimal("1.6"),
            "avg_volume": 100000,
            "avg_spread": Decimal("1.50"),
        }
    }
...
@pytest.fixture
def phase_d():
    """Create test Phase D classification."""
