# Story 5.4: CORRECTED Task List (Team-Approved Formula)

**ALIGNMENT STATUS:** ✅ Tasks aligned with team-reviewed acceptance criteria (2025-11-03)

**CRITICAL NOTES:**
- Function signature: `calculate_spring_confidence(spring: Spring, creek: CreekLevel, previous_tests: list[Test] = []) -> SpringConfidence`
- Return type: SpringConfidence dataclass (NOT int)
- Total scoring: 120 points possible (100 base + 20 bonuses), capped at 100
- REMOVED components: Spread narrowness, Range quality, Phase bonus
- NEW components: Creek strength bonus (+10), Volume trend bonus (+10)
