...
SPLIT INTO SUB-STORIES (Ready for Implementation)

## Implementation Split Notice
**IMPORTANT:** After comprehensive team review (2025-12-16), this story has been split into 3 manageable sub-stories due to scope (21 tasks, 255+ subtasks, 75+ content files, estimated 4 weeks):

- **[Story 11.8a: Core Help Infrastructure](11.8a.core-help-infrastructure.md)** (2 weeks)
  - Backend: Models, database, content loader, Markdown renderer, search, API endpoints
  - Frontend: HelpCenter, Glossary, HelpIcon, tooltips, routing
  - Content: 15 core files (5 phases, 4 patterns, 6 basic FAQ/reference)
  - Status: Ready for Implementation

- **[Story 11.8b: Tutorial System](11.8b.tutorial-system.md)** (1 week)
  - Backend: Tutorial models, parsing, API endpoints
  - Frontend: TutorialView, TutorialWalkthrough, step navigation
  - Content: 10 tutorials (5 basic usage, 3 pattern recognition, 2 risk management)
  - Status: Ready for Implementation (requires 11.8a completion)

- **[Story 11.8c: Advanced Content & Features](11.8c.advanced-content-features.md)** (1 week)
  - Frontend: FAQ accordion, ArticleFeedback, KeyboardShortcuts, SearchResults, ArticleView
  - Content: 50+ advanced files (VSA, schematics, concepts, advanced tutorials, expanded FAQ)
  - Testing: Performance benchmarking, complete E2E coverage, content audit
  - Status: Ready for Implementation (requires 11.8a + 11.8b completion)

**Recommended Implementation Order:** 11.8a → 11.8b → 11.8c

## Original Story (Historical Reference)
...
- [ ] **Task 3: Backend - Markdown Rendering** (AC: 8)
  ...
  - [ ] Subtask 3.5: Add custom renderer for Wyckoff term links: `[[Spring]]` → link to glossary entry
...
- [ ] **Task 10: Frontend - Help Icon Component** (AC: 2)
  ...
  - [ ] Subtask 10.7: Include feedback buttons at bottom: "Was this helpful? 👍 👎"
...
- [ ] **Task 13: Frontend - Tutorial Component** (AC: 4)
  ...
  - [ ] Subtask 13.10: Completion screen: "Tutorial completed! 🎉" with feedback prompt
...
- [ ] **Task 19: Frontend - Markdown Content Rendering** (AC: 8)
  ...
  - [ ] Subtask 19.8: Support custom Markdown extensions: glossary term links `[[Spring]]` → link to glossary
...
- [ ] **Task 21: Integration Testing** (AC: All)
  ...
  - [ ] Subtask 21.2: E2E test: Search for "Spring" → verify glossary result appears (Playwright)
  - [ ] Subtask 21.3: E2E test: Click glossary term → verify full definition displays (Playwright)
  - [ ] Subtask 21.4: E2E test: Hover over metric → verify tooltip appears (Playwright)
  - [ ] Subtask 21.5: E2E test: Click help icon next to feature → verify dialog opens with article (Playwright)
  - [ ] Subtask 21.6: E2E test: Navigate to FAQ → expand accordion item → verify answer displays (Playwright)
  - [ ] Subtask 21.7: E2E test: Start tutorial → navigate through steps → verify completion (Playwright)
  - [ ] Subtask 21.8: E2E test: Press "?" key → verify keyboard shortcuts overlay appears (Playwright)
  - [ ] Subtask 21.9: E2E test: Submit article feedback → verify success message (Playwright)
  - [ ] Subtask 21.10: E2E test: Search with no results → verify empty state message (Playwright)
...
4. **Signal Confidence Glossary (Subtask 5.10)**
   ...
   - **Rationale:** Connects Story 11.6 notifications (≥70% confidence threshold) to underlying scoring methodology. Users need to understand what "high confidence" means.
...
This ensures users can navigate from concepts → patterns → phases → practical application seamlessly.
...
│   │   ├── SOS.md
│   │   ├── LPS.md
│   │   ├── PS.md (Preliminary Support)
│   │   ├── SC.md (Selling Climax)
│   │   ├── AR.md (Automatic Rally)
│   │   ├── ST.md (Secondary Test)
│   │   ├── SOW.md (Sign of Weakness)
│   │   ├── LPSY.md (Last Point of Supply)
│   │   └── Backup.md
│   ├── levels/
│   │   ├── Creek.md
│   │   ├── Ice.md
...
│   │   └── Phase-E.md
│   ├── schematics/
│   │   ├── Accumulation-Schematic-1.md
│   │   ├── Accumulation-Schematic-2.md
│   │   ├── Distribution-Schematic-1.md
│   │   └── Distribution-Schematic-2.md
│   ├── vsa/
│   │   ├── No-Demand.md
│   │   ├── No-Supply.md
│   │   ├── Stopping-Volume.md
│   │   ├── Climactic-Volume.md
│   │   ├── Ultra-High-Volume.md
│   │   ├── High-Volume.md
│   │   ├── Low-Volume.md
│   │   └── Up-Thrust.md
│   ├── concepts/
│   │   ├── Composite-Operator.md
│   │   ├── Effort-vs-Result.md
│   │   ├── Cause-and-Effect.md
...
│   │   └── Resistance.md
│   └── signal/
│       └── Signal-Confidence.md
├── faq/
│   ├── What-is-Wyckoff.md
│   ├── How-are-signals-generated.md
│   ├── What-is-Composite-Operator.md
│   ├── How-to-read-Wyckoff-schematics.md
│   └── ...
├── tutorials/
...
│   ├── Reading-Wyckoff-Charts.md
│   ├── Identifying-Accumulation-Phases.md
│   ├── Understanding-Cause-Building.md
...
│   ├── Position-Sizing.md
│   └── Three-Phase-Position-Building.md
└── shortcuts.md
```
...
│   ├── api/
│   │   └── routes/
│   │       └── help.py                     # CREATE: Help API routes
│   ├── models/
│   │   └── help.py                         # CREATE: Help content models
│   ├── repositories/
│   │   └── help_repository.py              # CREATE: HelpRepository
│   ├── help/
│   │   ├── content_loader.py               # CREATE: Markdown file loader
│   │   ├── markdown_renderer.py            # CREATE: Markdown to HTML renderer
│   │   └── content/                        # CREATE: Content directory
│   │       ├── glossary/
│   │       │   ├── Spring.md
│   │       │   ├── UTAD.md
│   │       │   ├── SOS.md
...
├── alembic/
│   └── versions/
│       └── {timestamp}_add_help_tables.py  # CREATE: Migration for help_articles, help_feedback tables
├── tests/
│   ├── unit/
│   │   ├── test_content_loader.py          # CREATE: Unit tests for content loading
│   │   ├── test_markdown_renderer.py       # CREATE: Unit tests for Markdown rendering
│   │   └── test_help_search.py             # CREATE: Unit tests for search functionality
│   └── integration/
│       └── test_help_api.py                # CREATE: Integration tests for help endpoints
```
...
│   ├── components/
│   │   └── help/
│   │       ├── HelpCenter.vue              # CREATE: Main help center
│   │       ├── GlossaryView.vue            # CREATE: Glossary display
│   │       ├── FAQView.vue                 # CREATE: FAQ with accordion
│   │       ├── TutorialView.vue            # CREATE: Tutorial listing
│   │       ├── TutorialWalkthrough.vue     # CREATE: Step-by-step tutorial
│   │       ├── KeyboardShortcutsOverlay.vue # CREATE: Keyboard shortcuts overlay
│   │       ├── HelpIcon.vue                # CREATE: Help icon button
│   │       ├── MarkdownRenderer.vue        # CREATE: Markdown to HTML renderer
│   │       └── ArticleFeedback.vue         # CREATE: Feedback buttons
│   ├── composables/
│   │   ├── useTooltip.ts                   # CREATE: Tooltip helper
│   │   ├── useKeyboardShortcuts.ts         # CREATE: Global keyboard shortcuts
│   │   └── useGlobalSearch.ts              # CREATE: Search helper
│   ├── stores/
│   │   └── helpStore.ts                    # CREATE: Pinia store for help content
...
│   │   └── HelpFeedback.ts
│   ├── config/
│   │   └── tooltips.ts                     # CREATE: Tooltip content mapping
│   └── router/
│       └── index.ts                        # MODIFY: Add help routes
├── tests/
│   └── components/
│       ├── HelpCenter.spec.ts              # CREATE: Component tests
│       ├── GlossaryView.spec.ts            # CREATE: Glossary tests
│       ├── FAQView.spec.ts                 # CREATE: FAQ tests
│       ├── TutorialView.spec.ts            # CREATE: Tutorial tests
│       └── KeyboardShortcutsOverlay.spec.ts # CREATE: Shortcuts tests
```
...
tests/
└── e2e/
    └── help-system.spec.ts                 # CREATE: Playwright E2E tests
```
...
- **Playwright Tests**: Full user flow opening help center → searching → viewing article → submitting feedback
- Test keyboard shortcuts: press ? key → overlay appears
...
- E2E tests: Cover complete user journey opening help → searching → reading article → submitting feedback
