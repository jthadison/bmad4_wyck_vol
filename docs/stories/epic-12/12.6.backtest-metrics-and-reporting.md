...
- [ ] **Task 2: Backend - Enhanced Metrics Calculator** (AC: 2, 4, 5, 6, 7)
  ...
  - [ ] Subtask 2.9: Update `calculate_metrics()` method to call all new calculation functions
  - [ ] Subtask 2.10: Update BacktestResult construction to include all new fields
